...
> 풀스택 · 데이터 · DevOps를 넘나드는 소프트웨어 엔지니어입니다.
> 모바일 앱부터 데이터 파이프라인, 쿠버네티스 인프라, AI까지 폭넓게 다루고 있습니다.
...
<br/>
**Libraries** &nbsp; ReactQuery · Zustand · Styled Components · Three.js
<br/>
**Framework** &nbsp; Express · TailwindCSS
<br/>
**Database** &nbsp; MySQL · SQLAlchemy · Sequelize
<br/>
**Infra** &nbsp; NGINX · Airflow · Flink · Anaconda
<br/>
**Platform** &nbsp; RabbitMQ · MLflow · Trino · Superset · JupyterHub · Harbor · ECR
<br/>
**Tools** &nbsp; VSCode · Warp · XCode · Android Studio · Figma · Jira · Firebase · GA4
